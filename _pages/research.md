...
<div class="text-column">
    ...
    <p style="margin-left: 2em;">📅 <strong>Upcoming presentations:</strong> AFA 2027 Junior Faculty Mentoring Program (January 2027); NBER Climate Finance PhD Workshop (October 2025); FINEST Workshop (October 2025)</p>
    </div>

<div class="text-column">
    <ul>
    <li><a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4713016" class="paper-title">International Climate News</a> (with R. Colacito, M.M. Croce, and B. Yang) <strong><em>(R&amp;R at Review of Financial Studies)</em></strong></li>
    </ul>
    <p>Visit our webpage <a href="https://international-climate-news.github.io/">here</a>!</p>
...
<div class="text-column">
    ...
    <p><strong>Abstract:</strong> Using data from 2017 to 2024, we show that deviations from no-arbitrage in Bitcoin markets (the BTC basis) are systematically related to fiat currency basis deviations (CIP basis), with a one-percentage-point widening of the fiat basis associated with a 6 to 30 times larger widening of the BTC basis. We rationalize this amplification in an equilibrium model with segmented markets and financial frictions, in which crypto-market intermediaries face tighter balance-sheet constraints than fiat-market intermediaries. Consistent with the model, we extract an orthogonal crypto friction shock in the data. After controlling for other well-known predictive factors, this shock predicts equity returns and can help investors to optimize investments.</p>
...
<div class="text-column">
    <ul>
            <li><a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3560347" class="paper-title">When the Markets Get CO.V.I.D.: COntagion, Viruses, and Information Diffusion (2024)</a> (with M.M. Croce, P. Farroni and I. Wolfskeil) <em>Journal of Financial Economics</em>, Vol. 157: 103850.</li>
    </ul>
    <p>Visit our webpage <a href="https://when-markets-get-covid.github.io/">here</a>!</p>
